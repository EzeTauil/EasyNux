...
echo -e "${YELLOW}Instalación de Steam:${RESET}"
echo ""
sleep 1
...
# Instalar Steam
echo -e "${YELLOW}Instalando Steam desde Flathub...${RESET}"
flatpak install flathub com.valvesoftware.Steam -y

# Confirmación
if flatpak list | grep -q com.valvesoftware.Steam; then
    echo -e "${GREEN}¡Steam se ha instalado correctamente!${RESET}"
else
    echo -e "${RED}Ocurrió un error durante la instalación de Steam.${RESET}"
fi
